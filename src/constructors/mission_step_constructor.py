...
class Mission_Step_Constructor(Constructor_Base):
    _MISSION_STEPS_DATA_JSON = "dataset/json_bak/MissionSteps-module.json"

    _FILE_NAME = "dataset/data/MISSION_STEPS.md"
    _FILE_NAME_TMP = "dataset/data/MISSION_STEPS_TMP.md"
    _FILE_NAME_JSON = "dataset/json/mission_steps.json"
