...
class Quest_Constructor(Constructor_Base):
    _QUEST_DATA_JSON = "dataset/json_bak/QuestData-module.json"
    _QUEST_LINE_DATA_JSON = "dataset/json_bak/QuestLineData-module.json"
    _QUEST_LINE_JSON = "dataset/json/quest_lines.json"
   
    _quest_data = {}
    _quest_line_data = {}

    _FILE_NAME = "dataset/data/QUESTS.md"
    _FILE_NAME_TMP = "dataset/data/QUESTS_TMP.md"
    _FILE_NAME_JSON = "dataset/json/quests.json"
