...
class Star_Map_Constructor():
    _STAR_SYSTEM_DATA_JSON = "dataset/json_bak/StarSystemData-module.json"
    _CONSTELLATION_DATA_JSON = "dataset/json_bak/ConstellationData-module.json"

    _FILE_NAME = "dataset/data/STARMAP.md"
    _FILE_NAME_JSON = "dataset/json/starmap.json"
