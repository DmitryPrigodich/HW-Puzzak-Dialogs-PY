...
class Mission_Step_Actions_Constructor(Constructor_Base):
    _MISSION_STEPS_ACTIONS_DATA_JSON = "dataset/json_bak/MissionStepActions-module.json"

    _FILE_NAME = "dataset/data/MISSION_STACT.md"
    _FILE_NAME_TMP = "dataset/data/MISSION_STACT_TMP.md"
    _FILE_NAME_JSON = "dataset/json/mission_stact.json"
