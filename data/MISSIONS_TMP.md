...
## event_anniversary2023_Wiracoda_t1
	* MissionMode: Side
	* SystemId: {'coordinates': '[-1822, -636]', 'name': 'LAZARUS', 'faction': 'Medeans'}
	* DialogSequences:
...
## event_halloween2023_Rashidun_t1
	* MissionMode: Side
	* SystemId: {'coordinates': '[-1829, -578]', 'name': 'KRIITANA', 'faction': 'Cangacians'}
	* DialogSequences:
...
## event_iyaFal2023_Escort_t1
	* MissionMode: Side
	* SystemId: {'coordinates': '[-1722, -717]', 'name': 'MITORAI', 'faction': 'Medeans'}
	* DialogSequences:
...
## event_yaoSpr2024_Conjunction_t1
	* MissionMode: Side
	* SystemId: {'coordinates': '[-1710, -523]', 'name': 'ZE TAVAAN', 'faction': 'Cangacians'}
	* Factions:
		* P1
		* Yaot
	* StartingMissionSteps:
...
## story_A04_RelicSignature
	* MissionMode: Main
	* SystemId: {'coordinates': '[-1832, -619]', 'name': 'TOASIIM', 'faction': 'Medeans'}
	* StartingMissionSteps:
		* h_story_A04_RelicSignature_Start

## story_A05_Jolja
	* MissionMode: Main
	* SystemId: {'coordinates': '[-1764, -703]', 'name': 'INIIM', 'faction': 'Medeans'}
	* Factions:
		* Progenitor
		* Tanoch
	* StartingMissionSteps:
